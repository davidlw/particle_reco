...
config.JobType.psetName = '../python/MC_K_cfg.py'
...
if __name__ == '__main__':
    ...
    config.General.requestName = 'LambdaC_K_MC_pthat' + str(i) + requestNameTag;
    ...
    for i in [10, 20, 40, 80, 120]:
        ...
        print('Submitting task: pt_hat = ' + str(i))
        config.General.requestName = 'LambdaC_K_MC_pthat' + str(i) + requestNameTag
        config.Data.inputDataset = '/Pythia8_8160GeV_LambdaC_KsProton_GENSIM/zhchen-Pythia8_8160GeV_LambdaC_KsProton_pthat' + \
