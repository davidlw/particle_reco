...
process.lcreco = cms.EDAnalyzer('LambdaCData', LambdaCollection=cms.untracked.InputTag('generalV0CandidatesNew', 'Lambda'))

#specify output file
process.TFileService = cms.Service("TFileService", fileName = cms.string('data_LambdaC_L.root'))
